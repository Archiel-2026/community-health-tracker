                    ...
                    <?php if (!empty($labResults)): ?>
                        <div class="mb-8">
                            ...
                            <?php foreach ($labResults as $announcement): ?>
                                <div class="announcement-item card-shadow"
                                    style="border-left: 6px solid #10B981; background: linear-gradient(90deg,#F0FDF4 60%,#fff 100%);">
                                    <div class="announcement-header">
                                        <div class="flex-1">
                                            <h3 class="announcement-title text-green-700">
                                                <?= htmlspecialchars($announcement['title']) ?>
                                            </h3>
                                            <div class="announcement-meta">
                                                <span><i class="fas fa-user"></i>
                                                    <?= htmlspecialchars($announcement['staff_name'] ?? 'Medical Staff') ?></span>
                                                <span class="mx-2">•</span>
                                                <span><i class="fas fa-calendar"></i>
                                                    <?= date('M d, Y', strtotime($announcement['post_date'])) ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="announcement-badges mb-2">
                                        ...
                                        <span class="badge badge-<?= $announcement['priority'] ?>"><i class="fas fa-flag"></i>
                                            <?= ucfirst($announcement['priority']) ?></span>
                                        <?php if ($announcement['user_status']): ?>
                                            <span class="badge badge-<?= $announcement['user_status'] ?>">
                                                <i
                                                    class="fas fa-<?= $announcement['user_status'] === 'accepted' ? 'check' : 'times' ?>"></i>
                                    ...
                                    <?php if ($announcement['image_path']): ?>
                                        <div class="image-preview mb-2">
                                            <img src="<?= htmlspecialchars($announcement['image_path']) ?>" alt="Lab Result Image"
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <?php if ($announcement['user_status']): ?>
                                            <div class="flex items-center gap-2 p-2 rounded bg-green-50 border border-green-200">
                                                <i
                                                    class="fas fa-<?= $announcement['user_status'] === 'accepted' ? 'check-circle text-green-500' : 'times-circle text-gray-500' ?>"></i>
                                                <span class="font-semibold text-green-700">Response Recorded:
                                            ...
                                            <div class="flex gap-2">
                                                <form method="POST" action="" class="flex-1">
                                                    ...
                                                    <button type="submit" name="respond_to_announcement" value="accepted"
                                                        class="btn-response btn-accept w-full"><i class="fas fa-check-circle"></i>
                                                        Accept</button>
                                                </form>
                                                <form method="POST" action="" class="flex-1">
                                                    <input type="hidden" name="announcement_id" value="<?= $announcement['id'] ?>">
                                                    <button type="submit" name="respond_to_announcement" value="dismissed"
                                                        class="btn-response btn-dismiss w-full"><i class="fas fa-times-circle"></i>
                                                        Dismiss</button>
                                                </form>
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="mb-8">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-xl font-bold text-blue-700 flex items-center gap-2">
                                    ...
                                    <span
                                        class="text-base font-normal text-gray-500">(<?= count($basicAnnouncements) ?>)</span>
                                </h3>
                            </div>
                            <?php foreach ($basicAnnouncements as $announcement): ?>
                                <div class="announcement-item card-shadow"
                                    style="border-left: 6px solid #2563eb; background: linear-gradient(90deg,#DBEAFE 60%,#fff 100%);">
                                    <div class="announcement-header">
                                        <div class="flex-1">
                                            ...
                                            <div class="announcement-meta">
                                                <span><i class="fas fa-user"></i>
                                                    <?= htmlspecialchars($announcement['staff_name'] ?? 'Community Staff') ?></span>
                                                <span class="mx-2">•</span>
                                                <span><i class="fas fa-calendar"></i>
                                                    <?= date('M d, Y', strtotime($announcement['post_date'])) ?></span>
                                            </div>
                                    ...
                                    <div class="announcement-badges mb-2">
                                        ...
                                        <?php if ($announcement['user_status']): ?>
                                            <span class="badge badge-<?= $announcement['user_status'] ?>">
                                                <i
                                                    class="fas fa-<?= $announcement['user_status'] === 'accepted' ? 'check-circle' : 'times-circle' ?>"></i>
                                                <?= ucfirst($announcement['user_status']) ?>
                                            </span>
                                        <?php else: ?>
                                            <span class="badge badge-pending"><i class="fas fa-clock"></i> Pending</span>
