                                                    ...
                                                    <?php elseif ($announcement['user_status'] === 'dismissed'): ?>
                                                        <span class="badge badge-dismissed">
                                                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <circle cx="12" cy="12" r="10" fill="#F3F4F6" stroke="#D14343" stroke-width="2" />
                                                                <path d="M9 9L15 15M15 9L9 15" stroke="#D14343" stroke-width="2" stroke-linecap="round"/>
                                                            </svg>
                                                            Dismissed
                                                        </span>
                                                    <?php else: ?>
                                                        <span class="badge badge-pending">
                                                            <svg class="w-6 h-6" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M12.3748 11.5172L8.17886 7.5L12.3748 3.48281C12.3772 3.48013 12.3797 3.47759 12.3824 3.4752C12.5134 3.34409 12.6026 3.17708 12.6388 2.99528C12.6749 2.81348 12.6563 2.62505 12.5854 2.45379C12.5145 2.28254 12.3944 2.13616 12.2403 2.03314C12.0862 1.93012 11.905 1.87509 11.7197 1.875H3.28218C3.09688 1.8752 2.91579 1.93032 2.76178 2.03338C2.60778 2.13644 2.48778 2.28283 2.41693 2.45406C2.34608 2.62529 2.32757 2.81368 2.36372 2.99542C2.39988 3.17717 2.48909 3.34412 2.62007 3.4752L2.62711 3.48281L6.823 7.5L2.62711 11.5172L2.62007 11.5248C2.48909 11.6559 2.39988 11.8228 2.36372 12.0046C2.32757 12.1863 2.34608 12.3747 2.41693 12.5459C2.48778 12.7172 2.60778 12.8636 2.76178 12.9666C2.91579 13.0697 3.09688 13.1248 3.28218 13.125H11.7197C11.9051 13.125 12.0863 13.0701 12.2405 12.9671C12.3947 12.8641 12.5149 12.7178 12.5859 12.5465C12.6569 12.3752 12.6755 12.1867 12.6394 12.0049C12.6033 11.823 12.514 11.656 12.383 11.5248C12.3801 11.5224 12.3773 11.5199 12.3748 11.5172ZM11.7197 2.8125L7.50093 6.85078L3.28218 2.8125H11.7197ZM3.28218 12.1875L7.50093 8.14922L11.7197 12.1875H3.28218Z" fill="#FD8802"/>
                                                            </svg>
                                                            Pending
                                                        </span>
                                                    <?php endif; ?>
