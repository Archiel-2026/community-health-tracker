    ...
    <style>
        ...
        * {
        ...
        .log-tab {
            ...
            font-weight: 400;
            color: #3C96E1;
            background: rgba(60, 150, 225, 0.3);
            /* border: 1px solid #e5e7eb; */
            /* box-shadow: 0 1px 2px rgba(0, 0, 0, 0.05); */
        ...
        .log-tab:hover {
            background: rgba(60, 150, 225, 0.4);
        }
...
<body class="bg-gray-50">
    ...
    <div class="w-full px-8 py-10 lg:px-8">
        <div class="items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-700 flex items-center">Admin Dashboard</h1>
        </div>
        <!-- Top Stats Cards -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="rounded-xl bg-white border border-gray-100 shadow-sm p-6 flex flex-col">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800 mb-1">Recent Patient Records</h2>
                        <p class="text-gray-500 text-base">Latest patient entries</p>
                    </div>
                    <button
                        class="px-6 py-3 rounded bg-[#3C96E1] text-white font-semibold text-base hover:bg-blue-200 transition"
                        onclick="openRecordsModal(1)">View All</button>
                </div>
                <div class="flex flex-col gap-3">
                    <?php foreach (array_slice($stats['recent_patients'], 0, 3) as $patient): ?>
                        <div
                            class="flex items-center justify-between border border-gray-200 shadow-md rounded-lg px-4 py-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 rounded-full overflow-hidden border border-gray-200 flex items-center justify-center bg-white">
                                    <?php
                                    $profileImg = null;
                                    ...
                                    <?php else: ?>
                                        <span
                                            class="text-gray-400 font-bold text-lg"><?= strtoupper(substr($patient['full_name'], 0, 1)) ?></span>
                                    <?php endif; ?>
                                </div>
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500 flex gap-2 items-center">
                                        ...
                                        <span>-</span>
                                        <h1 class="font-semibold"><?= htmlspecialchars($patient['age'] ?? 'N/A') ?> </h1>
                                        <span>Year Old</span>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <button
                                    class="w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 text-blue-500"
                                    ...
                                    <svg viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M15.25 10.5C17.7353 10.5 19.75 12.5147 19.75 15C19.75 17.4853 17.7353 19.5 15.25 19.5C12.7647 19.5 10.75 17.4853 10.75 15C10.75 12.5147 12.7647 10.5 15.25 10.5Z"
                                            fill="#3C96E1" stroke="#3C96E1" />
                                        <path d="M26.5 15C26.5 15 25.25 5 15.25 5C5.25 5 4 15 4 15" stroke="#3C96E1"
                                            stroke-width="2" />
                                    </svg>
                                </button>
                                <button
                                    class="w-8 h-8 flex items-center justify-center rounded-full bg-green-50 hover:bg-green-100 text-green-500"
                                    onclick="showEditModal(<?= $patient['id'] ?>, '<?= addslashes($patient['full_name']) ?>')"
                                    title="Edit">
                                    <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M25.1062 4.01602C24.0797 2.98945 22.4203 2.98945 21.3937 4.01602L20.25 5.15977L24.8391 9.74883L25.9828 8.60508C27.0094 7.57852 27.0094 5.91914 25.9828 4.89258L25.1062 4.01602ZM11.0812 14.3285C10.7953 14.6145 10.575 14.966 10.4484 15.3551L9.06094 19.5176C8.925 19.9207 9.03281 20.366 9.33281 20.6707C9.63281 20.9754 10.0781 21.0785 10.4859 20.9426L14.6484 19.5551C15.0328 19.4285 15.3844 19.2082 15.675 18.9223L23.25 11.3379L18.6609 6.74883L11.0812 14.3285ZM7.5 5.99883C5.01562 5.99883 3 8.01445 3 10.4988V22.4988C3 24.9832 5.01562 26.9988 7.5 26.9988H19.5C21.9844 26.9988 24 24.9832 24 22.4988V17.9988C24 17.1691 23.3297 16.4988 22.5 16.4988C21.6703 16.4988 21 17.1691 21 17.9988V22.4988C21 23.3285 20.3297 23.9988 19.5 23.9988H7.5C6.67031 23.9988 6 23.3285 6 22.4988V10.4988C6 9.66914 6.67031 8.99883 7.5 8.99883H12C12.8297 8.99883 13.5 8.32852 13.5 7.49883C13.5 6.66914 12.8297 5.99883 12 5.99883H7.5Z"
                                            fill="#22C55E" />
                                    </svg>
                                </button>
                            </div>
