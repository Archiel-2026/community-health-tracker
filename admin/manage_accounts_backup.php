    ...
    <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="p-8">
            <form method="POST" action="" class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="form-group">
                    <label class="block text-sm font-bold text-gray-700 mb-2 ml-1">Position <span class="text-rose-500">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="specialization" 
                           class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all" 
                           placeholder="e.g., Pediatrics, OB-GYN, General Medicine">
                </div>
                <div class="form-group">
                    ...
                    <div class="space-y-3 mb-8 border-t border-b border-gray-50 py-6">
                        ...
                        <?php if ($staff['license_number']): ?>
                            <div class="flex items-center text-sm font-medium text-gray-500">
                                <i class="fas fa-id-card text-purple-400 mr-3 w-5"></i>
...
<section id="linking-section" class="fade-in" style="display: none;">
        ...
        <div class="modal-content max-w-xl">
            ...
            <div class="mb-6 pb-4 border-b-2 border-blue-100">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900">Change Staff Password</h3>
                            <p class="text-sm text-gray-500 mt-1">Update staff member's password securely</p>
                        </div>
                    </div>
            ...
            <form method="POST" action="" id="change-staff-password-form" onsubmit="return validateStaffPasswordForm()">
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900" id="change-staff-name"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-6">
                    ...
                    <div class="password-container relative">
                        <input type="password" name="current_password" required 
                               ...
                               class="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all" 
                               placeholder="Enter current password">
                        <button type="button" class="password-toggle" onclick="togglePassword('staff-current-password')">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                    <p class="text-xs text-gray-500 mt-1.5 ml-1"><i class="fas fa-shield-alt mr-1"></i>Verification required for security</p>
                </div>
                ...
                <div class="form-group mb-6">
                    ...
                    <p class="text-xs text-gray-500 mt-1.5 ml-1"><i class="fas fa-info-circle mr-1"></i>Minimum 6 characters recommended</p>
                </div>
                ...
                <div class="form-group mb-8">
                    ...
                    <div id="staff-password-match-message" class="text-xs mt-1.5 ml-1 hidden"></div>
                </div>
                
                <!-- Action Buttons -->
                <div class="flex gap-3 pt-4 border-t-2 border-gray-100">
                    <button type="button" onclick="closeChangeStaffPasswordModal()" class="flex-1 px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 transition-all">
                        <i class="fas fa-times mr-2"></i> Cancel
                    </button>
                    <button type="submit" name="change_staff_password" class="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-lg hover:from-blue-700 hover:to-blue-800 shadow-lg shadow-blue-200 transition-all transform hover:scale-105">
    ...
    <div id="changeResidentPasswordModal" class="modal">
        <div class="modal-content max-w-xl">
            <!-- Modal Header -->
            <div class="mb-6 pb-4 border-b-2 border-emerald-100">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900">Change Resident Password</h3>
                            <p class="text-sm text-gray-500 mt-1">Update resident account password securely</p>
                        </div>
                    </div>
            ...
            <form method="POST" action="" id="change-resident-password-form" onsubmit="return validateResidentPasswordForm()">
                ...
                <div class="bg-emerald-50 border-l-4 border-emerald-500 rounded-lg p-4 mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs text-emerald-600 font-semibold uppercase tracking-wide">Resident</p>
                            <p class="text-lg font-bold text-gray-900" id="change-resident-name"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-6">
                    ...
                    <div class="password-container relative">
                        <input type="password" name="current_password" required 
                               ...
                               class="w-full px-4 py-3 pr-12 border-2 border-gray-200 rounded-lg focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none transition-all" 
                               placeholder="Enter current password">
                ...
                <div class="form-group mb-8">
                    ...
                    <div id="resident-password-match-message" class="text-xs mt-1.5 ml-1 hidden"></div>
                </div>
                
                <!-- Action Buttons -->
                <div class="flex gap-3 pt-4 border-t-2 border-gray-100">
                    <button type="button" onclick="closeChangeResidentPasswordModal()" class="flex-1 px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 transition-all">
                        <i class="fas fa-times mr-2"></i> Cancel
                    </button>
                    <button type="submit" name="change_resident_password" class="flex-1 px-6 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-bold rounded-lg hover:from-emerald-700 hover:to-emerald-800 shadow-lg shadow-emerald-200 transition-all transform hover:scale-105">
                        <i class="fas fa-save mr-2"></i> Update Password
                    </button>
                </div>
            </form>
    ...
    <script>
        ...
        function checkPasswordMatch(type) {
            ...
            if (newPassword === confirmPassword) {
                message.className = 'text-xs mt-1.5 ml-1 text-green-600 flex items-center gap-1';
                message.innerHTML = '<i class="fas fa-check-circle"></i> Passwords match!';
            } else {
                message.className = 'text-xs mt-1.5 ml-1 text-red-600 flex items-center gap-1';
